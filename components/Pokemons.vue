<template>
  ...
  >
    <div
      ...
      :key="pokemon.name"
      :class="pokemonCardClass(pokemon.types)"
      class="relative rounded-lg overflow-hidden border border-gray-200 hover:shadow-lg transform hover:scale-105 transition duration-300 ease-in-out"
    >
      <div class="p-4">
        <img
      ...
      <div
        class="absolute inset-0 rounded-lg border-2 border-transparent animate-pulse"
      ></div>
      <!-- Glowing effect -->
